...
print bcolors.WARNING + "Please type the path of the ISO or Drag + Drop on this terminal window "
...
print bcolors.WARNING + "This part may take a while. Please give it up to 5 minutes" + bcolors.ENDC
